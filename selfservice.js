...
function positionBefore(id, order) {
  ...
  // De wachtrij is één gezamenlijke rij voor de zelfservice.
  // Keuken en bar blijven in "Mijn bestellingen" aparte kaarten, maar bij de
  // wachtrijtelling telt iedere kaart/bestelling mee in dezelfde fase.
  //
  // Dus bijvoorbeeld 2 keuken-bestellingen + 2 bar-bestellingen vóór deze
  // bestelling = 4 bestellingen voor je. We mogen keuken en bar hier NIET
  // samenvoegen op basis van orderGroupId.
  ...
  Object.entries(allOrders).forEach(([oid, o]) => {
    ...
    if (Number(o.tijd || 0) < mijnTijd) voorMij++;
  });
